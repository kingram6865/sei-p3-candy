...
export default function CarouselComponent() {
    return (
        ...
        <Carousel infiniteLoop useKeyboardArrows autoPlay showThumbs={false}>
                <div>
            <img src={`${process.env.PUBLIC_URL}/carousel-img/carousel1.png`} className="carousel-img" alt="candy1" />
                </div>
                <div>
                    <img src={`${process.env.PUBLIC_URL}/carousel-img/carousel2.png`} className="carousel-img" alt="candy2" />
                </div>
                <div>
                    <img src={`${process.env.PUBLIC_URL}/carousel-img/carousel3.png`} className="carousel-img" alt="candy3" />
                </div>
            </Carousel>
        </div>
    );
